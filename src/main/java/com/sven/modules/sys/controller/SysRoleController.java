...
import com.sven.modules.sys.service.SysRoleMenuService;
import com.sven.modules.sys.service.SysRoleService;
...
public class SysRoleController extends AbstractController {
	...
	public R save(@RequestBody SysRoleEntity role){
		...
		sysRoleService.saveRole(new HashSet<>(),role,getUserId());
	...
	public R update(@RequestBody SysRoleEntity role){
		...
		sysRoleService.update(new HashSet<>(),role,getUserId());
